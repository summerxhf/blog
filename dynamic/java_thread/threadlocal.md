...
1.   ThreadLocal 类中的ThreadLocalMap
...
2. ThreadLocalMap Entry中的key hashcode怎么自增?怎么均匀排列的
...
- 如果位置i已经有了Entry对象了, 并且key也不相等,那么只能找下一个空位置（key是否相等，equals方法，比较值是否一样）。
